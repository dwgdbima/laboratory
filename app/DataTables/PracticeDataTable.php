...
class PracticeDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->editColumn('created_at', function (Practice $practice) {
                return Carbon::createFromFormat('Y-m-d H:i:s', $practice->created_at)->format('d-m-Y H:i:s');
            })
            ->addColumn('action', '
     ...
     *
     * @param \App\Models\Practice $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Practice $model)
    {
