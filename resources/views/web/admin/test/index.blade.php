        ...
        <div class="modal-content">
            <form action="{{route('admin.tests.store')}}" method="post">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Tambah Pengujian</h4>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="form-edit" action="" method="post">
                ...
                @method('put')
                <div class="modal-header">
                    <h4 class="modal-title">Edit Pengujian</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<script>
    ...
    function edit(e, id){
        ...
        let url = '{{route("admin.tests.edit", ":id")}}',
            url_update = '{{route("admin.tests.update", ":id")}}';
    ...
    function _delete(e, id){
        ...
        let url = '{{route("admin.tests.destroy", ":id")}}';
        url = url.replace(':id', id);

        swal.fire({
            title: "Hapus Pengujian?",
            text: "Pengujian yang dihapus tidak bisa dikembalikan",
            icon: "warning",    
            ...
            if (result.value) {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        Swal.fire({
                            "title":"Berhasil Menghapus Pengujian!",
